 ...
 */
class ImageManagement extends AbstractManagement implements \Cobby\Connector\Api\ImportProductImageManagementInterface
{
    /**
    ...
    public function import($rows)
    {
        ...
        foreach ($mediaGallery as $prodId => $value) {
            ...
            $result[] = array(
                'product_id' => $prodId,
                \Cobby\Connector\Model\Export\Product::COL_IMAGE_GALLERY => $storedMediaGallery[$prodId],
                \Cobby\Connector\Model\Export\Product::COL_ATTRIBUTES => $productAttributes,
                'errors' => $value['errors']
            );
        }
